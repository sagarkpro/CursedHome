...
export default function ImageUploadField({ value, onUpload, onUploaded, helperText = "PNG, JPG, GIF, WEBP or BMP", className }: ImageUploadFieldProps) {
	...
	return (
		<button
			...
			className={cn(
				"group flex w-full flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-input p-6 transition-colors hover:border-ring hover:bg-muted/50 disabled:cursor-not-allowed disabled:opacity-70",
				className,
			)}
		>
			{uploading ? (
